...
#==============================================================================
    ...
    #--------------------------------------------------------------------------
    	...
    	"""
    	P2Peer.__init__(self, maxpeers, serverport)
        ...
        try:
    	    try:
        		...
        		if self.maxpeersreached():
        		    print('maxpeers %d reached: connection terminating'
        				  % self.maxpeers)
    ...
    #--------------------------------------------------------------------------
       ...
       try:
           ...
           if fname in self.files:
               print('Can\'t add duplicate file %s %s' %
    			      (fname, fpeerid))
           else:
    ...
    #--------------------------------------------------------------------------
        ...
        try:
            ...
            resp = self.connectandsend(host, port, INSERTPEER, '%s %s %d' % (self.myid, self.serverhost, self.serverport))[0]
            print(str(resp))
