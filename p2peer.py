...
class P2Peer:
    ...
    #--------------------------------------------------------------------------
        ...
        peerconn = P2PeerConnection( None, host, port, clientsock, debug=False )
        try:
...
class P2PeerConnection:
    ...
    #--------------------------------------------------------------------------
        msglen = len(msgdata)
        formated = "!4sL%ds" % msglen
        msg = struct.pack(formated.encode('ascii'), msgtype.encode('ascii'), msglen, msgdata.encode('ascii'))
        return msg
